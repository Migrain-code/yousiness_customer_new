...
$(function () {
  ...
  // ========== Form-select-option ========== //
  if( $('.form_items label input').is(':checked') ) {
    $('.form_items label input:checked').parent().addClass("active");
    $(".form_items label input:checked").after("<span class='checked'></span>");
  }
  ...
  $('.check-list label').on('change', function (e) {
    ...
    if ($(this).hasClass('active')) {
      ...
      $('.form_items label input:checked + span').remove();
