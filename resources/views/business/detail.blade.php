...
@section('meta_description', $business->name ." Detail")
@section('styles')
               ...
               <div>
                   <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                       <div class="carousel-indicators">
                           ...
                           @empty
                               <div class="alert alert-warning text-center">Die Fotogalerie des Salons konnte nicht gefunden werden.</div>
                           @endforelse
                    ...
                    <div class="d-flex mb-3">
                        ...
                        <div class="btn-group btn-group-toggle ust_menu_mar detail-links">
                            <div class="d-flex detail-links ">
                                    ...
                                    <a  class="gallery-button"><button type="button" class="company-buttons btn-search border border-right active company_left_menu" ><i class="fa fa-image"></i> <br> Galerie</button></a>
                                    <a href="#adres_company" class="adres"> <button type="button" class=" company-buttons btn-search border border-right company_left_menu"><i class="fa fa-map"></i> <br> Adresse</button></a>

                                    <a href="#iletisim_company"><button type="button" class=" company-buttons btn-search border border-right company_left_menu" style="width: 140px;"><i class="fa fa-phone"></i> Kommunikation</button></a>
                                    <a href="#comments"><button type="button"  style="width: 122px;" class=" company-buttons btn-search border border-right company_left_menu"><i class="fa fa-comment"></i> Kommentare</button></a>
                        ...
                        <ul>
                            @if($business->type->id == 3)
                                @if($manServiceCategories->count() > $womanServiceCategories->count())
                                    <li class="tab-titles active p-3 man" onclick="tabsFunction(this)">Mann</li>
                                    <li class="tab-titles p-3 woman" onclick="tabsFunction(this)">Frau</li>
                                @else
                                    <li class="tab-titles  p-3 man" onclick="tabsFunction(this)">Mann</li>
                                    <li class="tab-titles active p-3 woman" onclick="tabsFunction(this)">Frau</li>
                                @endif
                            @elseif($business->type->id == 2)
                                <li class="tab-titles p-3 active" onclick="tabsFunction(this)">Mann</li>
                        ...
                        <div class="glide-slider"  >
                            <div class="glide__track" data-glide-el="track">
                                <ul class="glide__slides">
                                    ...
                                    @empty
                                        <div class="alert alert-warning text-center">Die Fotogalerie des Unternehmens konnte nicht gefunden werden</div>
                                    @endforelse
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="informations">
                        <div>
                            <div class="information-title ms-0" data-aos="fade-up">
                                <h2 id="iletisim_company" style="margin-bottom: -10px;">Kommunikation </h2>
                        ...
                        <div>
                            <div class="information-title" data-aos="fade-up">
                                <h2 data-aos="fade-left" style="margin-bottom: -10px;">über uns</h2>
                        ...
                        <div>
                            <div class="information-title" data-aos="fade-up">
                                <h2 id="adres_company" style="margin-bottom: -10px;" data-aos="fade-left">Adresse</h2>
                        ...
                        <div>
                            <div class="information-title" data-aos="fade-up">
                                <h2 data-aos="fade-left" style="margin-bottom: -10px;" >Öffnungszeiten</h2>
                        ...
                        <div>
                            <div class="information-title" data-aos="fade-up">
                                <h2 data-aos="fade-left" style="margin-bottom: -10px;">Mitarbeiter</h2>
                                ...
                                <div class="row">
                                    @forelse($business->personel as $personel)
                                        <div class="col-md-3 col-xs-3 my-2 text-center" style="border-right: 1px solid lightgrey">
                                            <img     style="max-width: 150px" src="{{image($personel->image)}}" alt="Mitarbeiter">
                        ...
                        <div class="information-title" data-aos="fade-up" id="comments">
                            ...
                            <div class="d-flex">
                                <div class="row">
                                     <h2 id="yorumlar_company" style="margin-bottom: -10px;" data-aos="fade-left">Kommentare</h2>
                                ...
                                <h3 data-aos="fade-left">({{$business->comments()->where('status', 1)->count()}}) Kommentar</h3>
                            </div>
                            <hr>
                        ...
                        @empty
                            <div class="alert alert-warning">Es liegen keine Kommentare für den Salon vor.</div>
                        @endforelse
                    </div>
                </div>
            </div>
